/**
 * Inline brand-glyph SVGs (Instagram, YouTube, Facebook, WhatsApp).
 *
 * This project's `lucide-react` build ships no brand icons, and brand marks
 * shouldn't come from a CDN anyway — so the official simple-icons paths are
 * inlined here. Each icon inherits the current text colour via `fill`, so
 * colour is controlled with Tailwind text-* classes on the parent link.
 */
